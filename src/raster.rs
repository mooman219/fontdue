// The functions [Raster::draw_line, Raster::draw_curve] are licensed under the Apache License,
// Version 2.0 (the "License"); you may not use those functions except in compliance with the
